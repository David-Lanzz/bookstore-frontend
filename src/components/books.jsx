...
import { booksFromAPI, deleteFromAPI } from '../redux/features/books/bookSlice';
...
const Books = () => {
  ...
  if (isLoading) {
    return (
      <div className="loadparent"><img src={myLogo} alt="loading image" className="loadingImg" /></div>
    );
  }
